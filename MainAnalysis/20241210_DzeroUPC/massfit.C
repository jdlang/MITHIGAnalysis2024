...
struct EventParams {
  ...
  EventParams& operator=(const EventParams& other) {
    if (this != &other) {
      // Copy RooRealVars
      nsig.setVal(other.nsig.getValV());
      nbkg.setVal(other.nbkg.getValV());
      fswp.setVal(other.fswp.getValV());
      fpkkk.setVal(other.fpkkk.getValV());
      fpkpp.setVal(other.fpkpp.getValV());
