              ...
              int DmassNBins)
{
  ...
  pullCanvas->SetName("canvas_massfit_pull");
  pullCanvas->Write();
  ...
  pullCanvas->SetName("canvas_massfit_pull_legend");
  pullCanvas->Write();
  ...
  pullCanvas->SetName("canvas_massfit_pull_param_legend");
  pullCanvas->Write();
  ...
  pullCanvas->SetName("canvas_massfit_pull_param");
  pullCanvas->Write();
