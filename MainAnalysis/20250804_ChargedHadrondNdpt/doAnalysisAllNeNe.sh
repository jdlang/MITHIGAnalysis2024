...
./RunParallelReadParam.sh --Output ${MODE} --Input NeNe_InputFileList_Reference.txt --CollisionSystem true --ApplyEventSelection true --UseEventWeight false --UseSpeciesWeight false --UseTrackWeight true --TrackWeightSelection 2 --MinTrackPt 400 --MinLeadingTrackPt -1 --TriggerChoice 1 --EventSelectionOption 1 --SpeciesCorrectionOption 0 --ScaleFactor 1
