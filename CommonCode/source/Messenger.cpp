...
bool DzeroTreeMessenger::Initialize()
{
   ...
   if(Tree->GetBranch("Dtrk2PixelHit")) Tree->SetBranchAddress("Dtrk2PixelHit", &Dtrk1PixelHit);
   if(Tree->GetBranch("Dtrk2StripHit")) Tree->SetBranchAddress("Dtrk2StripHit", &Dtrk1StripHit);
...
DzeroUPCTreeMessenger::~DzeroUPCTreeMessenger()
{
   if(Initialized == true && WriteMode == true)
   {
      ...
      if (DpassCutDefault != nullptr) delete DpassCutDefault;
      if (DpassCutSystDsvpvSig != nullptr) delete DpassCutSystDsvpvSig;
      if (DpassCutSystDtrkPt != nullptr) delete DpassCutSystDtrkPt;
      if (DpassCutSystDalpha != nullptr) delete DpassCutSystDalpha;
      if (DpassCutSystDchi2cl != nullptr) delete DpassCutSystDchi2cl;
      if (DtrkCut_PtQuality != nullptr) delete DtrkCut_PtQuality;
      if (DtrkCut_HitQuality != nullptr) delete DtrkCut_HitQuality;
      delete Dy;
      delete Dmass;
      delete Dtrk1Pt;
      if (Dtrk1PtErr != nullptr) delete Dtrk1PtErr;
      if (Dtrk1Eta != nullptr) delete Dtrk1Eta;
      if (Dtrk1dedx != nullptr) delete Dtrk1dedx;
      if (Dtrk1MassHypo != nullptr) delete Dtrk1MassHypo;
      if (Dtrk1PixelHit != nullptr) delete Dtrk1PixelHit;
      if (Dtrk1StripHit != nullptr) delete Dtrk1StripHit;
      delete Dtrk2Pt;
      if (Dtrk2PtErr != nullptr) delete Dtrk2PtErr;
      if (Dtrk2Eta != nullptr) delete Dtrk2Eta;
      if (Dtrk2dedx != nullptr) delete Dtrk2dedx;
      if (Dtrk2MassHypo != nullptr) delete Dtrk2MassHypo;
      if (Dtrk2PixelHit != nullptr) delete Dtrk2PixelHit;
      if (Dtrk2StripHit != nullptr) delete Dtrk2StripHit;
      delete Dchi2cl;
...
bool DzeroUPCTreeMessenger::Initialize(bool Debug)
{
   ...
   DtrkCut_PtQuality = nullptr;
   DtrkCut_HitQuality = nullptr;
   Dy = nullptr;
   Dmass = nullptr;
   Dtrk1Pt = nullptr;
   Dtrk1PtErr = nullptr;
   ...
   if(Tree->GetBranch("DtrkCut_PtQuality")) Tree->SetBranchAddress("DtrkCut_PtQuality", &DtrkCut_PtQuality);
   if(Tree->GetBranch("DtrkCut_HitQuality")) Tree->SetBranchAddress("DtrkCut_HitQuality", &DtrkCut_HitQuality);
   Tree->SetBranchAddress("Dgen", &Dgen);
...
bool DzeroUPCTreeMessenger::SetBranch(TTree *T)
{
   ...
   DtrkCut_PtQuality = new std::vector<bool>();
   DtrkCut_HitQuality = new std::vector<bool>();
   ...
   Tree->Branch("DtrkCut_PtQuality",     &DtrkCut_PtQuality);
   Tree->Branch("DtrkCut_HitQuality",    &DtrkCut_HitQuality);
...
void DzeroUPCTreeMessenger::Clear()
{
   ...
   Dmass->clear();
   Dtrk1Pt->clear();
   if (Dtrk1PtErr != nullptr) Dtrk1PtErr->clear();
   if (Dtrk1Eta != nullptr) Dtrk1Eta->clear();
   if (Dtrk1dedx != nullptr) Dtrk1dedx->clear();
   if (Dtrk1MassHypo != nullptr) Dtrk1MassHypo->clear();
   if (Dtrk1PixelHit != nullptr) Dtrk1PixelHit->clear();
   if (Dtrk1StripHit != nullptr) Dtrk1StripHit->clear();
   Dtrk2Pt->clear();
   if (Dtrk2PtErr != nullptr) Dtrk2PtErr->clear();
   if (Dtrk2Eta != nullptr) Dtrk2Eta->clear();
   if (Dtrk2dedx != nullptr) Dtrk2dedx->clear();
   if (Dtrk2MassHypo != nullptr) Dtrk2MassHypo->clear();
   if (Dtrk2PixelHit != nullptr) Dtrk2PixelHit->clear();
   if (Dtrk2StripHit != nullptr) Dtrk2StripHit->clear();
   Dchi2cl->clear();
   DsvpvDistance->clear();
   DsvpvDisErr->clear();
   ...
   if (DpassCutDefault != nullptr) DpassCutDefault->clear();
   if (DpassCutSystDsvpvSig != nullptr) DpassCutSystDsvpvSig->clear();
   if (DpassCutSystDtrkPt != nullptr) DpassCutSystDtrkPt->clear();
   if (DpassCutSystDalpha != nullptr) DpassCutSystDalpha->clear();
   if (DpassCutSystDchi2cl != nullptr) DpassCutSystDchi2cl->clear();
   if (DtrkCut_PtQuality != nullptr) DtrkCut_PtQuality;
   if (DtrkCut_HitQuality != nullptr) DtrkCut_HitQuality;
   Dgen->clear();
   DisSignalCalc->clear();
...
void DzeroUPCTreeMessenger::CopyNonTrack(DzeroUPCTreeMessenger &M)
{
   ...
   if(DtrkCut_PtQuality != nullptr && M.DtrkCut_PtQuality != nullptr)   *DtrkCut_PtQuality = *(M.DtrkCut_PtQuality);
   if(DtrkCut_HitQuality != nullptr && M.DtrkCut_HitQuality != nullptr)   *DtrkCut_HitQuality = *(M.DtrkCut_HitQuality);
